...
<html lang="en">
<head>
    <title>Code coverage report for js/jquery.device.detector.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">js/</a> jquery.device.detector.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">97.52% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>157/161</span>
      </div>
      <div class='fl pad1y space-right2'>
...
1205
1206
1207</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  $.fn.deviceDetector = function(options) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof options !== undefined) $.extend(true, config, options);
    return true;
  };
&nbsp;
  /**
...
<span class="branch-1 cbranch-no" title="branch not covered" >    isDeviceType(</span>
      config.vendors.lbu.unixlike.pattern.include,
      config.vendors.lbu.unixlike.pattern.exclude
    ) ||
<span class="branch-2 cbranch-no" title="branch not covered" >    isDeviceType(</span>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (hasExcludes === false) hasIncludes = isMatching(includes);
&nbsp;
      return hasIncludes;
    } catch (error) {
<span class="cstat-no" title="statement not covered" >      console.info( // eslint-disable-line no-console</span>
...
<span class="cstat-no" title="statement not covered" >        version = parseFloat(</span>
...
&nbsp;
  ...
  function isSupported() {
    ...
    $.each(config.supports, function(key, value) {
      ...
      ) <span class="cstat-no" title="statement not covered" >isSupported = true;</span>
    });
    return isSupported;
  }
&nbsp;
...
&nbsp;
  ...
  browserVersionString = browserAgentString || <span class="branch-1 cbranch-no" title="branch not covered" >browserVersionString;</span>
&nbsp;
  // config
  //
  //  vendor
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sat Oct 06 2018 02:59:38 GMT+0200 (CEST)
</div>
</div>
